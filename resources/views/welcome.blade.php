    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-6">
                <div class="single-offer-box">
                    <a href="shop-grid.html" class="d-block">
                        <img src="assets/img/offer/offer4.jpg" alt="offer-image">
                    </a>
                </div>
            </div>
            <div class="col-lg-6 col-md-6">
                <div class="single-offer-box">
                    <a href="shop-grid.html" class="d-block">
                        <img src="assets/img/offer/offer5.jpg" alt="offer-image">
                    </a>
                </div>
            </div>
        </div>
...
<div class="offer-area pb-75">
    <div class="container">
        <div class="single-offer-box">
            <a href="shop-grid.html" class="d-block">
                <img src="assets/img/offer/offer6.jpg" alt="offer-image">
            </a>
        </div>
    </div>
</div>
        ...
        <div class="row justify-content-center">
            <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12">
                <div class="offer-box">
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-md-6">
                            <div class="image">
                                <img src="assets/img/offer/offer7.png" alt="offer-image">
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <div class="content">
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                <div class="single-products-box">
                    <div class="image">
                        <a href="products-details.html" class="d-block">
                            <img src="assets/img/products/products13.jpg" alt="products-image">
                        </a>
                        <ul class="products-button">
                            <li><a href="cart.html"><i class='bx bx-cart-alt'></i></a></li>
                            <li><a href="wishlist.html"><i class='bx bx-heart'></i></a></li>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                <div class="single-products-box">
                    <div class="image">
                        <a href="products-details.html" class="d-block">
                            <img src="assets/img/products/products14.jpg" alt="products-image">
                        </a>
                        <ul class="products-button">
                            <li><a href="cart.html"><i class='bx bx-cart-alt'></i></a></li>
                            <li><a href="wishlist.html"><i class='bx bx-heart'></i></a></li>
