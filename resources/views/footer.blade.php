<footer class="footer-area">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="single-footer-widget">
                    ...
                    <ul class="footer-contact-info">
                        ...
                        <li><span>Email:</span><a href="#">gabrielmburu63@gmail.com</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6">
    ...
    <div class="copyright-area">
        <div class="container">
            <p>Copyright @2021 <span>Pet Mundu</span>. Design & Developed by <a href="https://iconztech.com/">Icons Tech</a></p>
        </div>
    </div>
</footer>
